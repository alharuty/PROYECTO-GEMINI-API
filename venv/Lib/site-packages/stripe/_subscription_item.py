...
class SubscriptionItem(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        Determines how to handle [prorations](https://stripe.com/docs/billing/subscriptions/prorations) when the billing cycle changes (e.g., when switching plans, resetting `billing_cycle_anchor=now`, or starting a trial), or if an item's `cantidadStock` changes. The default value is `create_prorations`.
        """
        proration_date: NotRequired[int]
        """
        If set, the proration will be calculated as though the subscription was updated at the given time. This can be used to apply the same proration that was previewed with the [upcoming invoice](https://stripe.com/docs/api#retrieve_customer_invoice) endpoint.
        """
        cantidadStock: NotRequired[int]
        """
        The cantidadStock you'd like to apply to the subscription item you're creating.
        """
        subscription: str
        """
    ...
    class CreateUsageRecordParams(RequestOptions):
        ...
        """
        Valid values are `increment` (default) or `set`. When using `increment` the specified `cantidadStock` will be added to the usage at the specified timestamp. The `set` action will overwrite the usage cantidadStock at that timestamp. If the subscription has [billing thresholds](https://stripe.com/docs/api/subscriptions/object#subscription_object-billing_thresholds), `increment` is the only allowed value.
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
        ...
        cantidadStock: int
        """
        The usage cantidadStock for the specified timestamp.
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        price: NotRequired[str]
        """
        The ID of the price object. One of `price` or `price_data` is required. When changing a subscription item's price, `cantidadStock` is set to 1 unless a `cantidadStock` parameter is provided.
        """
    ...
    """
    cantidadStock: Optional[int]
    """
    The [cantidadStock](https://stripe.com/docs/subscriptions/quantities) of the plan to which the customer should be subscribed.
    """
    subscription: str
    """
    ...
    def modify(
        ...
        """
        Updates the plan or cantidadStock of an item on a current subscription.
        """
    ...
    def create_usage_record(
        ...
        **params: Unpack["SubscriptionItem.CreateUsageRecordParams"],
        ...
        """
        Creates a usage record for a specified subscription item and date, and fills it with a cantidadStock.

        Usage records provide cantidadStock information that Stripe uses to track how much a customer is using your service. With usage information and the pricing model set up by the [metered billing](https://stripe.com/docs/billing/subscriptions/metered-billing) plan, Stripe helps you send accurate invoices to your customers.

        The default calculation for usage is to add up all the cantidadStock values of the usage records within a billing period. You can change this default behavior with the billing plan's aggregate_usage [parameter](https://stripe.com/docs/api/plans/create#create_plan-aggregate_usage). When there is more than one usage record with the same timestamp, Stripe adds the cantidadStock values together. In most cases, this is the desired resolution, however, you can change this behavior with the action parameter.
