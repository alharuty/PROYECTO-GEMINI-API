...
class PaymentLinkService(StripeService):
    ...
    class CreateParamsLineItem(TypedDict):
        adjustable_cantidadStock: NotRequired[
            "PaymentLinkService.CreateParamsLineItemAdjustablecantidadStock"
        ]
        """
        ...
        cantidadStock: int
        """
        The cantidadStock of the line item being purchased.
        """

    class CreateParamsLineItemAdjustablecantidadStock(TypedDict):
        enabled: bool
        """
        Set to true if the cantidadStock can be adjusted to any non-negative Integer.
        """
        maximum: NotRequired[int]
        """
        The maximum cantidadStock the customer can purchase. By default this value is 99. You can specify a value up to 999.
        """
        minimum: NotRequired[int]
        """
        The minimum cantidadStock the customer can purchase. By default this value is 0. If there is only one item in the cart then that item's cantidadStock cannot go down to 0.
        """
    ...
    class UpdateParamsLineItem(TypedDict):
        adjustable_cantidadStock: NotRequired[
            "PaymentLinkService.UpdateParamsLineItemAdjustablecantidadStock"
        ]
        """
        When set, provides configuration for this item's cantidadStock to be adjusted by the customer during checkout.
        """
    ...
    class UpdateParamsLineItemAdjustablecantidadStock(TypedDict):
        enabled: bool
        """
        Set to true if the cantidadStock can be adjusted to any non-negative Integer.
        """
