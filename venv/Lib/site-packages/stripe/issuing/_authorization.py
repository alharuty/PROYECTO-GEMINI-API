...
class Authorization(
    ...
    class Fleet(StripeObject):
        ...
        class ReportedBreakdown(StripeObject):
            class Fuel(StripeObject):
                ...
                """
                Gross fuel amount that should equal Fuel cantidadStock multiplied by Fuel Unit Cost, inclusive of taxes.
                """
    ...
    class Fuel(StripeObject):
        ...
        """
        cantidadStock_decimal: Optional[str]
        """
        The cantidadStock of `unit`s of fuel that was dispensed, represented as a decimal string with at most 12 decimal places.
        """
        type: Optional[
            Literal[
                "diesel",
        ...
        """
        The units for `cantidadStock_decimal`.
        """
    ...
    class CaptureParamsPurchaseDetailsFuel(TypedDict):
        ...
        [Conexxus Payment System Product Code](https://www.conexxus.org/conexxus-payment-system-product-codes) identifying the primary fuel product purchased.
        """
        cantidadStock_decimal: NotRequired[str]
        """
        The cantidadStock of `unit`s of fuel that was dispensed, represented as a decimal string with at most 12 decimal places.
        """
        type: NotRequired[
        ...
        """
        The units for `cantidadStock_decimal`. One of `charging_minute`, `imperial_gallon`, `kilogram`, `kilowatt_hour`, `liter`, `pound`, `us_gallon`, or `other`.
        """
