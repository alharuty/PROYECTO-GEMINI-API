...
class InvoiceItem(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        The integer unit amount in cents (or local equivalent) of the charge to be applied to the upcoming invoice. This `unit_amount` will be multiplied by the cantidadStock to get the full amount. Passing in a negative `unit_amount` will reduce the `amount_due` on the invoice.
        """
    ...
    amount: int
    """
    Amount (in the `currency` specified) of the invoice item. This should always be equal to `unit_amount * cantidadStock`.
    """
    currency: str
    """
    Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
    ...
    cantidadStock: int
    """
    cantidadStock of units for the invoice item. If the invoice item is a proration, the cantidadStock of the subscription that the proration was computed for.
    """
