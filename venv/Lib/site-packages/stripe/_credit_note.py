...
class CreditNote(
    ...
    class CreateParamsLine(TypedDict):
        ...
        """
        The line item cantidadStock to credit.
        """
        ...
        """
        The integer unit amount in cents (or local equivalent) of the credit note line item. This `unit_amount` will be multiplied by the cantidadStock to get the full amount to credit for this line item. Only valid when `type` is `custom_line_item`.
        """
