...
class PaymentLink(
    ...
    class CreateParamsLineItem(TypedDict):
        adjustable_cantidadStock: NotRequired[
            "PaymentLink.CreateParamsLineItemAdjustablecantidadStock"
        ]
        """
    ...
    class ModifyParamsLineItem(TypedDict):
        adjustable_cantidadStock: NotRequired[
            "PaymentLink.ModifyParamsLineItemAdjustablecantidadStock"
        ]
        """
        When set, provides configuration for this item's cantidadStock to be adjusted by the customer during checkout.
        """
    ...
    class ModifyParamsLineItemAdjustablecantidadStock(TypedDict):
        enabled: bool
        """
        Set to true if the cantidadStock can be adjusted to any non-negative Integer.
        """
