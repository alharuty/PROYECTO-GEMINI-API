...
class Invoice(
    ...
    class ThresholdReason(StripeObject):
        class ItemReason(StripeObject):
            ...
            usage_gte: int
            """
            The cantidadStock threshold boundary that applied to the given line item.
            """
    ...
    class AddLinesParamsLine(TypedDict):
        ...
        """
        Non-negative integer. The cantidadStock of units for the line item.
        """
    ...
    class CreatePreviewParamsInvoiceItem(TypedDict):
        ...
        cantidadStock: NotRequired[int]
        """
        Non-negative integer. The cantidadStock of units for the invoice item.
        """
        tax_behavior: NotRequired[
            Literal["exclusive", "inclusive", "unspecified"]
        ]
        ...
        unit_amount: NotRequired[int]
        """
        The integer unit amount in cents (or local equivalent) of the charge to be applied to the upcoming invoice. This unit_amount will be multiplied by the cantidadStock to get the full amount. If you want to apply a credit to the customer's account, pass a negative unit_amount.
        """
        unit_amount_decimal: NotRequired[str]
        """
        Same as `unit_amount`, but accepts a decimal value in cents (or local equivalent) with at most 12 decimal places. Only one of `unit_amount` and `unit_amount_decimal` can be set.
    ...
    class CreatePreviewParamsScheduleDetailsPhaseAddInvoiceItem(TypedDict):
        ...
        cantidadStock: NotRequired[int]
        """
        cantidadStock for this item. Defaults to 1.
        """
        tax_rates: NotRequired["Literal['']|List[str]"]
        """
    ...
    class CreatePreviewParamsScheduleDetailsPhaseItem(TypedDict):
        ...
        cantidadStock: NotRequired[int]
        """
        cantidadStock for the given price. Can be set only if the price's `usage_type` is `licensed` and not `metered`.
        """
        tax_rates: NotRequired["Literal['']|List[str]"]
        """
    ...
    class UpcomingLinesParams(RequestOptions):
        ...
        """
        Determines how to handle [prorations](https://stripe.com/docs/billing/subscriptions/prorations) when the billing cycle changes (e.g., when switching plans, resetting `billing_cycle_anchor=now`, or starting a trial), or if an item's `cantidadStock` changes. The default value is `create_prorations`. This field has been deprecated and will be removed in a future API version. Use `subscription_details.proration_behavior` instead.
        """
