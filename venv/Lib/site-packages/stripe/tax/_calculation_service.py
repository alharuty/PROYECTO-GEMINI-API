...
class CalculationService(StripeService):
    ...
    class CreateParamsLineItem(TypedDict):
        ...
        """
        The number of units of the item being purchased. Used to calculate the per-unit price from the total `amount` for the line. For example, if `amount=100` and `cantidadStock=4`, the calculated unit price is 25.
        """
