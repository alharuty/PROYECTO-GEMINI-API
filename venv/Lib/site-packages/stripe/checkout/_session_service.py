...
class SessionService(StripeService):
    ...
    class CreateParamsLineItem(TypedDict):
        adjustable_cantidadStock: NotRequired[
            "SessionService.CreateParamsLineItemAdjustablecantidadStock"
        ]
        """
        When set, provides configuration for this item's cantidadStock to be adjusted by the customer during Checkout.
        """
        ...
        """
        The cantidadStock of the line item being purchased. cantidadStock should not be defined when `recurring.usage_type=metered`.
        """
    ...
    class CreateParamsLineItemAdjustablecantidadStock(TypedDict):
        enabled: bool
        """
        Set to true if the cantidadStock can be adjusted to any non-negative integer. By default customers will be able to remove the line item by setting the cantidadStock to 0.
        """
        maximum: NotRequired[int]
        """
        The maximum cantidadStock the customer can purchase for the Checkout Session. By default this value is 99. You can specify a value up to 999999.
        """
        minimum: NotRequired[int]
        """
        The minimum cantidadStock the customer must purchase for the Checkout Session. By default this value is 0.
        """
